...
am__depfiles_remade = ./$(DEPDIR)/ARM_runner_example.Po \
	./$(DEPDIR)/arm_simulator_interface.Po ./$(DEPDIR)/csapp.Po \
	./$(DEPDIR)/debug.Po ./$(DEPDIR)/gdb_protocol.Po \
	./$(DEPDIR)/scanner.Po ./$(DEPDIR)/util.Po
am__mv = mv -f
...
ACLOCAL = ${SHELL} "/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/missing" aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} "/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/missing" autoconf
AUTOHEADER = ${SHELL} "/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/missing" autoheader
AUTOMAKE = ${SHELL} "/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/missing" automake-1.16
AWK = mawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} "/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/missing" makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = elf_linker
...
STRIP = 
VERSION = 1.0
abs_builddir = /mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0
abs_srcdir = /mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0
abs_top_builddir = /mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0
abs_top_srcdir = /mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} '/mnt/d/Mes Cours/SEM5/PROG5/elf_linker-1.0/build-aux/install-sh'
...
include ./$(DEPDIR)/ARM_runner_example.Po # am--include-marker
include ./$(DEPDIR)/arm_simulator_interface.Po # am--include-marker
include ./$(DEPDIR)/csapp.Po # am--include-marker
include ./$(DEPDIR)/debug.Po # am--include-marker
include ./$(DEPDIR)/gdb_protocol.Po # am--include-marker
include ./$(DEPDIR)/scanner.Po # am--include-marker
...
distclean: distclean-recursive
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/ARM_runner_example.Po
	-rm -f ./$(DEPDIR)/arm_simulator_interface.Po
	-rm -f ./$(DEPDIR)/csapp.Po
	-rm -f ./$(DEPDIR)/debug.Po
	-rm -f ./$(DEPDIR)/gdb_protocol.Po
